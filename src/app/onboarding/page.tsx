            ...
            <div>
                ...
                {SUPPORTED_LANGUAGES.map((lang) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-3.5 rounded-2xl border-2 text-left transition-all flex flex-col justify-between relative group active:scale-95 ${
                        isSelected
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end">
                <button
                  type="button"
                  onClick={() => setStep(2)}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-md shadow-indigo-100 active:scale-95 transition-all"
                >
            ...
            <div>
                ...
                {ENGLISH_LEVELS.map((level) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4.5 rounded-2xl border-2 text-left transition-all flex items-start gap-4 active:scale-98 ${
                        isSelected
                          ? 'border-indigo-600 bg-indigo-50/50 shadow-sm ring-2 ring-indigo-200'
                          : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50/50'
                      }`}
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={saving}
                  className="inline-flex items-center gap-2 px-7 py-3 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-md shadow-indigo-100 active:scale-95 transition-all disabled:opacity-50"
                >
                  {saving ? (
                    <>
