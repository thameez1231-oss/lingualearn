      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3.5 text-base bg-white border border-slate-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 font-medium text-slate-900 placeholder:text-slate-400"
          />
        </div>
            ...
            return (
              ...
              >
                <div>
                  ...
                  {/* Native Translation */}
                  <div className="mt-4 p-3 bg-indigo-50/70 border border-indigo-100 rounded-2xl">
