...
export function InteractiveHeroDemo() {
  ...
  return (
    <div className="mt-16 max-w-3xl mx-auto bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-100 p-6 sm:p-8 text-left transition-all">
      {/* Card Header */}
      ...
      <div className="flex items-center gap-2 my-4 overflow-x-auto no-scrollbar py-1">
        ...
        {sampleChips.map((chip, idx) => (
          <button
            ...
            className="px-3 py-1 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-full text-xs font-semibold whitespace-nowrap active:scale-95 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
        ...
        <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200/80">
          <div className="flex items-center justify-between text-xs font-bold text-slate-500 mb-3">
            ...
            <span className="px-2 py-0.5 bg-slate-200 text-slate-700 rounded-md">Native Input</span>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-200/60">
            ...
            >
              <input
                ...
                className="flex-1 px-3 py-1.5 text-xs bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500 text-slate-800"
              />
              <button
                type="submit"
                disabled={loading}
        ...
        <div className="bg-gradient-to-br from-indigo-50/70 to-violet-50/70 rounded-2xl p-5 border border-indigo-100 flex flex-col justify-between">
          <div>
          ...
          <div className="flex items-center justify-between mt-4 pt-3 border-t border-indigo-100/80">
            <span className="text-xs font-medium text-slate-500">
              Phonetic: <span className="font-semibold text-slate-700">{result.phoneticGuide}</span>
            </span>
      ...
      <div className="mt-5 text-center sm:text-left text-xs text-slate-500 flex items-center justify-center sm:justify-start gap-2">
